...
public class VillagerTrades {
   ...
   static class DyedArmorForEmeraldsTrade implements VillagerTrades.ITrade {
      ...
      public DyedArmorForEmeraldsTrade(Item itemIn, int p_i50540_2_) {
         this(itemIn, p_i50540_2_, 12, 1);
      }

      public DyedArmorForEmeraldsTrade(Item p_i50541_1_, int p_i50541_2_, int p_i50541_3_, int p_i50541_4_) {
         this.tradeItem = p_i50541_1_;
         this.price = p_i50541_2_;
         this.maxUses = p_i50541_3_;
         this.xpValue = p_i50541_4_;
      }
   ...
   static class EmeraldForMapTrade implements VillagerTrades.ITrade {
      ...
      public EmeraldForMapTrade(int p_i50525_1_, String structureNameIn, MapDecoration.Type decoration, int p_i50525_4_, int p_i50525_5_) {
         this.count = p_i50525_1_;
         this.structureName = structureNameIn;
         this.mapDecorationType = decoration;
         this.maxUses = p_i50525_4_;
         this.xpValue = p_i50525_5_;
      }

      @Nullable
      public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
         World world = p_221182_1_.world;
         BlockPos blockpos = world.findNearestStructure(this.structureName, new BlockPos(p_221182_1_), 100, true);
         if (blockpos != null) {
   ...
   static class EnchantedItemForEmeraldsTrade implements VillagerTrades.ITrade {
      ...
      public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
         ...
         ItemStack itemstack = EnchantmentHelper.addRandomEnchantment(p_221182_2_, new ItemStack(this.sellingStack.getItem()), i, false);
   ...
   static class ItemWithPotionForEmeraldsAndItemsTrade implements VillagerTrades.ITrade {
      ...
      public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
         ...
         ItemStack itemstack1 = PotionUtils.addPotionToItemStack(new ItemStack(this.field_221219_a.getItem(), this.potionCount), potion);
         return new MerchantOffer(itemstack, new ItemStack(this.field_221224_f, this.field_221225_g), itemstack1, this.maxUses, this.xpValue, this.priceMultiplier);
      }
   }
   ...
   static class ItemsForEmeraldsAndItemsTrade implements VillagerTrades.ITrade {
      ...
      @Nullable
      public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
         return new MerchantOffer(new ItemStack(Items.EMERALD, this.emeraldCount), new ItemStack(this.field_221200_a.getItem(), this.field_221201_b), new ItemStack(this.field_221203_d.getItem(), this.field_221204_e), this.maxUses, this.xpValue, this.priceMultiplier);
      }
   }
