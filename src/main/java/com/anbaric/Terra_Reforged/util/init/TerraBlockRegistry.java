...
//    public static final RegistryObject<Block> WALL_DARKOAK_LEAF = null;
    ...
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_BASE = BLOCKS.register("dungeon_blue_wall_base", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_TOP = BLOCKS.register("dungeon_blue_wall_top", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_MID = BLOCKS.register("dungeon_blue_wall_mid", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_BOT = BLOCKS.register("dungeon_blue_wall_bot", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    ...
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_BASE = BLOCKS.register("dungeon_green_wall_base", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_TOP = BLOCKS.register("dungeon_green_wall_top", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_MID = BLOCKS.register("dungeon_green_wall_mid", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_BOT = BLOCKS.register("dungeon_green_wall_bot", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    ...
    public static final RegistryObject<Block> DUNGEON_RED_WALL_BASE = BLOCKS.register("dungeon_red_wall_base", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_TOP = BLOCKS.register("dungeon_red_wall_top", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_MID = BLOCKS.register("dungeon_red_wall_mid", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_BOT = BLOCKS.register("dungeon_red_wall_bot", () -> new TerraBlockWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F, 9.0F)));
