...
public class TerraBiomeForestCorrupt extends Biome {
    public TerraBiomeForestCorrupt(Builder biomeBuilder) {
        super(new Builder()
                .surfaceBuilder(TerraSurfaceBuilderRegistry.BASE_CORRUPT, TerraSurfaceBuilderRegistry.GRASS_CORRUPT_CONFIG).precipitation(RainType.RAIN).category(Category.FOREST)
                .depth(0.1F).scale(0.2F).temperature(0.7F).downfall(0.8F).waterColor(1771829).waterFogColor(2955068).parent("corrupt"));
