...
public class TerraBlockHangingTallLanternPoweredEffect extends Block
{
    ...
    public TerraBlockHangingTallLanternPoweredEffect(Properties properties, double topShape, double botShape, int light, Effect effect)
    {
        super(properties);
