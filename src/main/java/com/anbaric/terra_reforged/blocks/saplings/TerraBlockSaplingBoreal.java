...
public class TerraBlockSaplingBoreal extends BushBlock implements IGrowable
{
    ...
    public TerraBlockSaplingBoreal(Properties properties)
    {
        super(properties);
    ...
    public void placeTree(ServerWorld world, BlockPos pos, BlockState state, Random rand)
    {
        ...
        else
        {
            ...
            TerraFeatureRegistry.BOREAL_TREE.get().generate(world, world.getChunkProvider().getChunkGenerator(), rand, pos, NoFeatureConfig.NO_FEATURE_CONFIG);
        }
    }
