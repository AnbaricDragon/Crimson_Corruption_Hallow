...
import com.anbaric.terra_reforged.features.vegetation.trees.TerraTreeEbon;
...
public class TerraBlockSaplingEbon extends BushBlock implements IGrowable
{
    ...
    public TerraBlockSaplingEbon(Properties properties)
    {
        super(properties);
    ...
    public void grow(ServerWorld worldIn, BlockPos pos, BlockState state, Random rand)
    {
        ...
        else
        {
            ...
            TerraTreeEbon.generateTree(worldIn, pos, rand);
        }
