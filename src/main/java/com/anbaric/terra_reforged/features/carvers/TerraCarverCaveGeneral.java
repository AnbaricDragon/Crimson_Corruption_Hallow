...
public class TerraCarverCaveGeneral extends WorldCarver<ProbabilityConfig>
{
    public TerraCarverCaveGeneral(Codec<ProbabilityConfig> p_i231917_1_, int p_i231917_2_)
    {
