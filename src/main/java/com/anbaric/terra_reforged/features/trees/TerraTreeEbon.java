...
public class TerraTreeEbon extends Tree
{
    public static final BlockState LOG = TerraBlockRegistry.LOG_EBON.get().getDefaultState();
    public static final BlockState LEAF = TerraBlockRegistry.LEAF_EBON.get().getDefaultState();
    ...
    public static final TreeFeatureConfig BOREAL_TREE_CONFIG = new TreeFeatureConfig.Builder(
            ...
            .setSapling((IPlantable) TerraBlockRegistry.SAPLING_EBON.get()).build();
