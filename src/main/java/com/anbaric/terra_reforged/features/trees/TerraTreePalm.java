...
public class TerraTreePalm extends Tree
{
    public static final BlockState LOG = TerraBlockRegistry.LOG_PALM.get().getDefaultState();
    public static final BlockState LEAF = TerraBlockRegistry.LEAF_PALM.get().getDefaultState();
    ...
    public static final TreeFeatureConfig BOREAL_TREE_CONFIG = new TreeFeatureConfig.Builder(
            ...
            .setSapling((IPlantable) TerraBlockRegistry.SAPLING_PALM.get()).build();
