...
public class TerraTreeShade extends Tree
{
    public static final BlockState LOG = TerraBlockRegistry.LOG_SHADE.get().getDefaultState();
    public static final BlockState LEAF = TerraBlockRegistry.LEAF_SHADE.get().getDefaultState();
    ...
    public static final TreeFeatureConfig BOREAL_TREE_CONFIG = new TreeFeatureConfig.Builder(
            ...
            .setSapling((IPlantable) TerraBlockRegistry.SAPLING_SHADE.get()).build();
