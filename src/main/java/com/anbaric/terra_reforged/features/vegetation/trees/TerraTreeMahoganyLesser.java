...
public class TerraTreeMahoganyLesser extends Feature<NoFeatureConfig>
{
    ...
    public TerraTreeMahoganyLesser(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory)
    {
        super(configFactory);
    }
