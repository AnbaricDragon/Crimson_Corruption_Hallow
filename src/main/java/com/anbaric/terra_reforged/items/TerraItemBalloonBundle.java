    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public List<Component> getSlotsTooltip(List<Component> tooltips)
            {
                ...
                toolTip.add(new TranslatableComponent("tooltip.terra_reforged.extra_jump_3").withStyle(ChatFormatting.BLUE));
                toolTip.add(new TranslatableComponent("tooltip.terra_reforged.jump_height_150").withStyle(ChatFormatting.BLUE));
                return toolTip;
            }
