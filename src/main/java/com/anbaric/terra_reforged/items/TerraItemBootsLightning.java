...
public class TerraItemBootsLightning extends TerraItemAccessory
{
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.add(new StringTextComponent("\u00A79" + "+30% Speed"));
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundNBT unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid)
            {
                ...
                atts.put(Attributes.MOVEMENT_SPEED, new AttributeModifier(uuid, Reference.MODID + ":genericBonus", 0.30F, AttributeModifier.Operation.MULTIPLY_BASE));
                return atts;
            }
