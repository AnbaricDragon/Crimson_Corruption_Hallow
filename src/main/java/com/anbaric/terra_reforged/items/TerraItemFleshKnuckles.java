...
public class TerraItemFleshKnuckles extends TerraItemAccessory
{
    public TerraItemFleshKnuckles()
    {
        super();
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundNBT unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            {
                if (livingEntity.ticksExisted % 100 == 0 && livingEntity instanceof PlayerEntity)
                {
            ...
            public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid)
            {
                ...
                atts.put(Attributes.ARMOR, new AttributeModifier(uuid, Reference.MODID + ":fleshKnucklesBonus", 2.0, AttributeModifier.Operation.ADDITION));
                return atts;
            }
