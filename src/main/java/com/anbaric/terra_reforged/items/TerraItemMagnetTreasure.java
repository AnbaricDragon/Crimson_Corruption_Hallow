...
public class TerraItemMagnetTreasure extends TerraItemAccessory
{
    public TerraItemMagnetTreasure()
    {
        super();
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public List<Component> getSlotsTooltip(List<Component> tooltips)
            {
                ...
                toolTip.add(new TranslatableComponent("tooltip.terra_reforged.more_pickup_range").withStyle(ChatFormatting.BLUE).append(new TranslatableComponent("tooltip.terra_reforged.condition_items").withStyle(ChatFormatting.BLUE)));
                return toolTip;
            }
            ...
            public void curioTick(SlotContext slotContext)
            {
                ...
                if (cooldown <= 0)
                {
                    ...
                    {
                        if (((TerraItemMagnetTreasure) stack.getItem()).canPullItem(item))
                        {
                            if (pulled > 200) { break; }
