...
public class TerraItemRoseSkull extends TerraItemAccessory
{
    public TerraItemRoseSkull()
    {
        super();
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public boolean canEquip(SlotContext slotContext)
            {
                ...
                return !CurioHandler.hasBauble((Player) slotContext.entity(), TerraTagRegistry.BURNING_NEGATORS, TerraTagRegistry.LAVA_RESISTORS);
            }
