    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public boolean canEquip(SlotContext slotContext)
            {
                ...
                return !CurioHandler.hasBauble((Player) slotContext.entity(), TerraTagRegistry.BURNING_NEGATORS, TerraTagRegistry.WATER_WALKERS);
            }
            ...
            public List<Component> getSlotsTooltip(List<Component> tooltips)
            {
                ...
                toolTip.add(new TranslatableComponent("tooltip.terra_reforged.walking_water").withStyle(ChatFormatting.BLUE));
