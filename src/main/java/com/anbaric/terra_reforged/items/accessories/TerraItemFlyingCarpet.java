...
public class TerraItemFlyingCarpet extends TerraItemAccessory
{
    public TerraItemFlyingCarpet()
    {
        super();
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public List<Component> getSlotsTooltip(List<Component> tooltips)
            {
                ...
                toolTip.add(new TranslatableComponent("tooltip.terra_reforged.flying_carpet").withStyle(ChatFormatting.BLUE));
                return toolTip;
            }@Nonnull
            @Override
