    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public boolean canEquip(SlotContext slotContext)
            {
                ...
                return !CurioHandler.hasBauble((Player) slotContext.entity(), TerraTagRegistry.FROG_FALLERS, TerraTagRegistry.FROG_HIGH_JUMPERS, TerraTagRegistry.WATER_SPEEDERS);
            }
            ...
            public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid)
            {
                ...
                atts.put(ForgeMod.SWIM_SPEED.get(), new AttributeModifier(uuid, Reference.MODID + ":frog_flipper_bonus", 0.30F, AttributeModifier.Operation.MULTIPLY_BASE));
                return atts;
            }
