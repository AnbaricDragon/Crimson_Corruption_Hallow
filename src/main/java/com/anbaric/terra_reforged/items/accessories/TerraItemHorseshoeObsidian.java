...
public class TerraItemHorseshoeObsidian extends TerraItemAccessory
{
    public TerraItemHorseshoeObsidian()
    {
        super();
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public boolean canEquip(SlotContext slotContext)
            {
                ...
                return !CurioHandler.hasBauble((Player) slotContext.entity(), TerraTagRegistry.FALL_PROTECTORS, TerraTagRegistry.BURNING_NEGATORS);
            }
