...
public class TerraItemManaCloak extends TerraItemAccessory
{
    public TerraItemManaCloak()
    {
        super();
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public List<Component> getSlotsTooltip(List<Component> tooltips)
            {
                ...
                toolTip.add(new TranslatableComponent("tooltip.terra_reforged.entity_spawn_mana_star").withStyle(ChatFormatting.BLUE).append(new TranslatableComponent("tooltip.terra_reforged.condition_damage").withStyle(ChatFormatting.BLUE)));
