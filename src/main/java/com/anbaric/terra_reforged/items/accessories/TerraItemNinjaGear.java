    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused)
    {
        return CurioHandler.createProvider(new ICurio()
        {
            ...
            public boolean canEquip(SlotContext slotContext)
            {
                ...
                return !CurioHandler.hasBauble((Player) slotContext.entity(), TerraTagRegistry.DAMAGE_DODGERS, TerraTagRegistry.WALL_GRIPPERS, TerraTagRegistry.TABI_DASHERS);
            }
            ...
            public void curioTick(SlotContext slotContext)
            {
                ...
                if (slotContext.entity() instanceof Player && slotContext.entity().getLevel().isClientSide())
                {
