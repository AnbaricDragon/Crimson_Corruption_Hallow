...
public class TerraAttributeRegistry
{
    ...
    public static final RegistryObject<Attribute> MANA_MAX = ATTRIBUTES.register("max_mana", () -> new RangedAttribute("attribute.name.terra_reforged.max_mana", 20.0D, 20.0D, 400.0D).setSyncable(true));
