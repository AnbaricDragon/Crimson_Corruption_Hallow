...
public class TerraBiomeRegistry
{
    ...
    public static final RegistryObject<Biome> CORRUPT_TAIGA = BIOMES.register("corrupt_taiga", BiomeMaker::makeVoidBiome);
    ...
    public static final RegistryObject<Biome> CRIMSON_TAIGA = BIOMES.register("crimson_taiga", BiomeMaker::makeVoidBiome);
    ...
    public static final RegistryObject<Biome> HALLOWED_TAIGA = BIOMES.register("hallowed_taiga", BiomeMaker::makeVoidBiome);
