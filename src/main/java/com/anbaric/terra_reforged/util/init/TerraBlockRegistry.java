...
public class TerraBlockRegistry
{
    ...
    //Soils
    public static final RegistryObject<Block> SOIL_MUD = BLOCKS.register("soil_mud", () -> new Block(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(0.7F)));
    public static final RegistryObject<Block> SOIL_ASH = BLOCKS.register("soil_ash", () -> new Block(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(0.7F)));
    ...
    public static final RegistryObject<Block> SAND_HARDEBON = BLOCKS.register("sand_hardebon", () -> new TerraBlockSpreading(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(1.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> SAND_HARDCRIM = BLOCKS.register("sand_hardcrim", () -> new TerraBlockSpreading(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(1.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> SAND_HARDPEARL = BLOCKS.register("sand_hardpearl", () -> new TerraBlockSpreading(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(1.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    ...
    public static final RegistryObject<Block> SANDSTONE_CRIM = BLOCKS.register("sandstone_crim", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_CRIM_CHISELED = BLOCKS.register("sandstone_crim_chiseled", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_CRIM_SMOOTH = BLOCKS.register("sandstone_crim_smooth", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_CRIM_CUT = BLOCKS.register("sandstone_crim_cut", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_PEARL = BLOCKS.register("sandstone_pearl", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_PEARL_CHISELED = BLOCKS.register("sandstone_pearl_chiseled", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_PEARL_SMOOTH = BLOCKS.register("sandstone_pearl_smooth", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> SANDSTONE_PEARL_CUT = BLOCKS.register("sandstone_pearl_cut", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_EBON = BLOCKS.register("stone_ebon", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_EBON_SMOOTH = BLOCKS.register("stone_ebon_smooth", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> COBBLESTONE_EBON = BLOCKS.register("cobblestone_ebon", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> COBBLESTONE_EBON_MOSSY = BLOCKS.register("cobblestone_ebon_mossy", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_EBON = BLOCKS.register("stonebrick_ebon", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_EBON_CRACKED = BLOCKS.register("stonebrick_ebon_cracked", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_EBON_CHISELED = BLOCKS.register("stonebrick_ebon_chiseled", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_EBON_MOSSY = BLOCKS.register("stonebrick_ebon_mossy", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CORRUPT, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_CRIM = BLOCKS.register("stone_crim", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_CRIM_SMOOTH = BLOCKS.register("stone_crim_smooth", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> COBBLESTONE_CRIM = BLOCKS.register("cobblestone_crim", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> COBBLESTONE_CRIM_MOSSY = BLOCKS.register("cobblestone_crim_mossy", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_CRIM = BLOCKS.register("stonebrick_crim", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_CRIM_CRACKED = BLOCKS.register("stonebrick_crim_cracked", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_CRIM_CHISELED = BLOCKS.register("stonebrick_crim_chiseled", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_CRIM_MOSSY = BLOCKS.register("stonebrick_crim_mossy", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.CRIMSON, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_PEARL = BLOCKS.register("stone_pearl", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_PEARL_SMOOTH = BLOCKS.register("stone_pearl_smooth", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> COBBLESTONE_PEARL = BLOCKS.register("cobblestone_pearl", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> COBBLESTONE_PEARL_MOSSY = BLOCKS.register("cobblestone_pearl_mossy", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_PEARL = BLOCKS.register("stonebrick_pearl", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_PEARL_CRACKED = BLOCKS.register("stonebrick_pearl_cracked", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_PEARL_CHISELED = BLOCKS.register("stonebrick_pearl_chiseled", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONEBRICK_PEARL_MOSSY = BLOCKS.register("stonebrick_pearl_mossy", () -> new TerraBlockSpreading(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly(), EnumBiomeType.HALLOWED, PlantType.CAVE));
    public static final RegistryObject<Block> STONE_MOSS_RED = BLOCKS.register("stone_moss_red", () -> new TerraBlockMoss(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly()));
    public static final RegistryObject<Block> STONE_MOSS_YELLOW = BLOCKS.register("stone_moss_yellow", () -> new TerraBlockMoss(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly()));
    public static final RegistryObject<Block> STONE_MOSS_GREEN = BLOCKS.register("stone_moss_green", () -> new TerraBlockMoss(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly()));
    public static final RegistryObject<Block> STONE_MOSS_BLUE = BLOCKS.register("stone_moss_blue", () -> new TerraBlockMoss(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly()));
    public static final RegistryObject<Block> STONE_MOSS_PURPLE = BLOCKS.register("stone_moss_purple", () -> new TerraBlockMoss(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly()));
    public static final RegistryObject<Block> STONE_MOSS_FIRE = BLOCKS.register("stone_moss_fire", () -> new TerraBlockMoss(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F).tickRandomly()));
    ...
    //Woods
    public static final RegistryObject<Block> LOG_BOREAL = BLOCKS.register("log_boreal", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PALM = BLOCKS.register("log_palm", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.YELLOW_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_MAHOGANY = BLOCKS.register("log_mahogany", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.NETHERRACK).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_EBON = BLOCKS.register("log_ebon", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PURPLE_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_SHADE = BLOCKS.register("log_shade", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.RED_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PEARL = BLOCKS.register("log_pearl", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_BOREAL_SOLID = BLOCKS.register("log_boreal_solid", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PALM_SOLID = BLOCKS.register("log_palm_solid", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.YELLOW_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_MAHOGANY_SOLID = BLOCKS.register("log_mahogany_solid", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.NETHERRACK).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_EBON_SOLID = BLOCKS.register("log_ebon_solid", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PURPLE_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_SHADE_SOLID = BLOCKS.register("log_shade_solid", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.RED_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PEARL_SOLID = BLOCKS.register("log_pearl_solid", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_BOREAL_STRIPPED = BLOCKS.register("log_boreal_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PALM_STRIPPED = BLOCKS.register("log_palm_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.YELLOW_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_MAHOGANY_STRIPPED = BLOCKS.register("log_mahogany_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.NETHERRACK).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_EBON_STRIPPED = BLOCKS.register("log_ebon_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PURPLE_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_SHADE_STRIPPED = BLOCKS.register("log_shade_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.RED_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PEARL_STRIPPED = BLOCKS.register("log_pearl_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_BOREAL_SOLID_STRIPPED = BLOCKS.register("log_boreal_solid_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PALM_SOLID_STRIPPED = BLOCKS.register("log_palm_solid_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.YELLOW_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_MAHOGANY_SOLID_STRIPPED = BLOCKS.register("log_mahogany_solid_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.NETHERRACK).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_EBON_SOLID_STRIPPED = BLOCKS.register("log_ebon_solid_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PURPLE_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_SHADE_SOLID_STRIPPED = BLOCKS.register("log_shade_solid_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.RED_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_PEARL_SOLID_STRIPPED = BLOCKS.register("log_pearl_solid_stripped", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.PINK_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> LOG_MUSHROOM = BLOCKS.register("log_mushroom", () -> new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.CYAN_TERRACOTTA).sound(SoundType.WOOD).hardnessAndResistance(2.0F)));
    public static final RegistryObject<Block> MUSHROOM_CAP = BLOCKS.register("mushroom_cap", () -> new HugeMushroomBlock(Block.Properties.create(Material.WOOD, MaterialColor.BLUE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> PLANK_BOREAL = BLOCKS.register("plank_boreal", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_PALM = BLOCKS.register("plank_palm", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_MAHOGANY = BLOCKS.register("plank_mahogany", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_EBON = BLOCKS.register("plank_ebon", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_SHADE = BLOCKS.register("plank_shade", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_PEARL = BLOCKS.register("plank_pearl", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_SPOOKY = BLOCKS.register("plank_spooky", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    public static final RegistryObject<Block> PLANK_DYNASTY = BLOCKS.register("plank_dynasty", () -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)));
    ...
    public static final RegistryObject<Block> LILYPAD_CORRUPT = BLOCKS.register("lilypad_corrupt", () -> new LilyPadBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).notSolid()));
    public static final RegistryObject<Block> LILYPAD_CRIMSON = BLOCKS.register("lilypad_crimson", () -> new LilyPadBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).notSolid()));
    public static final RegistryObject<Block> LILYPAD_HALLOWED = BLOCKS.register("lilypad_hallowed", () -> new LilyPadBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).notSolid()));
    public static final RegistryObject<Block> VINE_RED = BLOCKS.register("vine_red", () -> new VineBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).tickRandomly().notSolid()));
    public static final RegistryObject<Block> VINE_YELLOW = BLOCKS.register("vine_yellow", () -> new VineBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).tickRandomly().notSolid()));
    public static final RegistryObject<Block> VINE_PINK = BLOCKS.register("vine_pink", () -> new VineBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).tickRandomly().notSolid()));
    public static final RegistryObject<Block> VINE_MAGENTA = BLOCKS.register("vine_magenta", () -> new VineBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).tickRandomly().notSolid()));
    public static final RegistryObject<Block> VINE_CYAN = BLOCKS.register("vine_cyan", () -> new VineBlock(Block.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).tickRandomly().notSolid()));
    ...
    public static final RegistryObject<Block> BRICK_ICE = BLOCKS.register("brick_ice", () -> new Block(Block.Properties.create(Material.ICE).sound(SoundType.GLASS).hardnessAndResistance(0.7F, 3.0F)));
    public static final RegistryObject<Block> BRICK_MUDSTONE = BLOCKS.register("brick_mudstone", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_ASHSTONE = BLOCKS.register("brick_ashstone", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_COPPER = BLOCKS.register("brick_copper", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_TIN = BLOCKS.register("brick_tin", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_SILVER = BLOCKS.register("brick_silver", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_TUNGSTEN = BLOCKS.register("brick_tungsten", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_GOLD = BLOCKS.register("brick_gold", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_PLATINUM = BLOCKS.register("brick_platinum", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_DEMONITE = BLOCKS.register("brick_demonite", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_CRIMTANE = BLOCKS.register("brick_crimtane", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_METEORITE = BLOCKS.register("brick_meteorite", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_OBSIDIAN = BLOCKS.register("brick_obsidian", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(50.0F, 1200.0F)));
    public static final RegistryObject<Block> BRICK_HELLSTONE = BLOCKS.register("brick_hellstone", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_COBALT = BLOCKS.register("brick_cobalt", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_PALLADIUM = BLOCKS.register("brick_palladium", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_MYTHRIL = BLOCKS.register("brick_mythril", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_ORICHALCUM = BLOCKS.register("brick_orichalcum", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_ADAMANTITE = BLOCKS.register("brick_adamantite", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_TITANIUM = BLOCKS.register("brick_titanium", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_CHLOROPHYTE = BLOCKS.register("brick_chlorophyte", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_LUMINITE = BLOCKS.register("brick_luminite", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_RAINBOW = BLOCKS.register("brick_rainbow", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_SUNPLATE = BLOCKS.register("brick_sunplate", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_STUCCO = BLOCKS.register("brick_stucco", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_STUCCO_RED = BLOCKS.register("brick_stucco_red", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_STUCCO_GREEN = BLOCKS.register("brick_stucco_green", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_STUCCO_YELLOW = BLOCKS.register("brick_stucco_yellow", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_FLESH = BLOCKS.register("brick_flesh", () -> new Block(Block.Properties.create(Material.SPONGE).sound(SoundType.PLANT).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> PLATE_TIN = BLOCKS.register("plate_tin", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> PLATE_COPPER = BLOCKS.register("plate_copper", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> PLATE_MARTIAN = BLOCKS.register("plate_martian", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> PLATE_SHROOMITE = BLOCKS.register("plate_shroomite", () -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.0F)));
    public static final RegistryObject<Block> BRICK_CRYSTAL = BLOCKS.register("brick_crystal", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_GRANITE = BLOCKS.register("brick_granite", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    public static final RegistryObject<Block> BRICK_MARBLE = BLOCKS.register("brick_marble", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5F, 6.0F)));
    ...
    public static final RegistryObject<Block> STAIR_PLANK_BOREAL = BLOCKS.register("stair_plank_boreal", () -> new StairsBlock(() -> TerraBlockRegistry.PLANK_BOREAL.get().getDefaultState(), Block.Properties.from(TerraBlockRegistry.PLANK_BOREAL.get())));
    public static final RegistryObject<Block> STAIR_PLANK_PALM = BLOCKS.register("stair_plank_palm", () -> new StairsBlock(() -> TerraBlockRegistry.PLANK_PALM.get().getDefaultState(), Block.Properties.from(TerraBlockRegistry.PLANK_PALM.get())));
    public static final RegistryObject<Block> STAIR_PLANK_MAHOGANY = BLOCKS.register("stair_plank_mahogany", () -> new StairsBlock(() -> TerraBlockRegistry.PLANK_MAHOGANY.get().getDefaultState(), Block.Properties.from(TerraBlockRegistry.PLANK_MAHOGANY.get())));
    public static final RegistryObject<Block> STAIR_PLANK_EBON = BLOCKS.register("stair_plank_ebon", () -> new StairsBlock(() -> TerraBlockRegistry.PLANK_EBON.get().getDefaultState(), Block.Properties.from(TerraBlockRegistry.PLANK_EBON.get())));
    public static final RegistryObject<Block> STAIR_PLANK_SHADE = BLOCKS.register("stair_plank_shade", () -> new StairsBlock(() -> TerraBlockRegistry.PLANK_SHADE.get().getDefaultState(), Block.Properties.from(TerraBlockRegistry.PLANK_SHADE.get())));
    ...
    public static final RegistryObject<Block> SLAB_PLANK_MAHOGANY = BLOCKS.register("slab_plank_mahogany", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.PLANK_MAHOGANY.get())));
    public static final RegistryObject<Block> SLAB_PLANK_EBON = BLOCKS.register("slab_plank_ebon", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.PLANK_EBON.get())));
    public static final RegistryObject<Block> SLAB_PLANK_SHADE = BLOCKS.register("slab_plank_shade", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.PLANK_SHADE.get())));
    public static final RegistryObject<Block> SLAB_PLANK_PEARL = BLOCKS.register("slab_plank_pearl", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.PLANK_PEARL.get())));
    public static final RegistryObject<Block> SLAB_PLANK_DYNASTY = BLOCKS.register("slab_plank_dynasty", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.PLANK_DYNASTY.get())));
    public static final RegistryObject<Block> SLAB_PLANK_SPOOKY = BLOCKS.register("slab_plank_spooky", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.PLANK_SPOOKY.get())));
    public static final RegistryObject<Block> SLAB_STONE_EBON = BLOCKS.register("slab_stone_ebon", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONE_EBON.get())));
    public static final RegistryObject<Block> SLAB_STONE_CRIM = BLOCKS.register("slab_stone_crim", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONE_CRIM.get())));
    public static final RegistryObject<Block> SLAB_STONE_PEARL = BLOCKS.register("slab_stone_pearl", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONE_PEARL.get())));
    public static final RegistryObject<Block> SLAB_STONE_EBON_SMOOTH = BLOCKS.register("slab_stone_ebon_smooth", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONE_EBON_SMOOTH.get())));
    public static final RegistryObject<Block> SLAB_STONE_CRIM_SMOOTH = BLOCKS.register("slab_stone_crim_smooth", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONE_CRIM_SMOOTH.get())));
    public static final RegistryObject<Block> SLAB_STONE_PEARL_SMOOTH = BLOCKS.register("slab_stone_pearl_smooth", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONE_PEARL_SMOOTH.get())));
    public static final RegistryObject<Block> SLAB_STONEBRICK_EBON = BLOCKS.register("slab_stonebrick_ebon", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONEBRICK_EBON.get())));
    public static final RegistryObject<Block> SLAB_STONEBRICK_CRIM = BLOCKS.register("slab_stonebrick_crim", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONEBRICK_CRIM.get())));
    public static final RegistryObject<Block> SLAB_STONEBRICK_PEARL = BLOCKS.register("slab_stonebrick_pearl", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONEBRICK_PEARL.get())));
    public static final RegistryObject<Block> SLAB_STONEBRICK_EBON_MOSSY = BLOCKS.register("slab_stonebrick_ebon_mossy", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONEBRICK_EBON_MOSSY.get())));
    public static final RegistryObject<Block> SLAB_STONEBRICK_CRIM_MOSSY = BLOCKS.register("slab_stonebrick_crim_mossy", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONEBRICK_CRIM_MOSSY.get())));
    public static final RegistryObject<Block> SLAB_STONEBRICK_PEARL_MOSSY = BLOCKS.register("slab_stonebrick_pearl_mossy", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.STONEBRICK_PEARL_MOSSY.get())));
    public static final RegistryObject<Block> SLAB_COBBLESTONE_EBON = BLOCKS.register("slab_cobblestone_ebon", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.COBBLESTONE_EBON.get())));
    public static final RegistryObject<Block> SLAB_COBBLESTONE_CRIM = BLOCKS.register("slab_cobblestone_crim", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.COBBLESTONE_CRIM.get())));
    public static final RegistryObject<Block> SLAB_COBBLESTONE_PEARL = BLOCKS.register("slab_cobblestone_pearl", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.COBBLESTONE_PEARL.get())));
    public static final RegistryObject<Block> SLAB_COBBLESTONE_EBON_MOSSY = BLOCKS.register("slab_cobblestone_ebon_mossy", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.COBBLESTONE_EBON_MOSSY.get())));
    public static final RegistryObject<Block> SLAB_COBBLESTONE_CRIM_MOSSY = BLOCKS.register("slab_cobblestone_crim_mossy", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.COBBLESTONE_CRIM_MOSSY.get())));
    public static final RegistryObject<Block> SLAB_COBBLESTONE_PEARL_MOSSY = BLOCKS.register("slab_cobblestone_pearl_mossy", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.COBBLESTONE_PEARL_MOSSY.get())));
    ...
    public static final RegistryObject<Block> SLAB_SANDSTONE_EBON_CUT = BLOCKS.register("slab_sandstone_ebon_cut", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.SANDSTONE_EBON_CUT.get())));
    public static final RegistryObject<Block> SLAB_SANDSTONE_CRIM_CUT = BLOCKS.register("slab_sandstone_crim_cut", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.SANDSTONE_CRIM_CUT.get())));
    public static final RegistryObject<Block> SLAB_SANDSTONE_PEARL_CUT = BLOCKS.register("slab_sandstone_pearl_cut", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.SANDSTONE_PEARL_CUT.get())));
    public static final RegistryObject<Block> SLAB_SANDSTONE_EBON_SMOOTH = BLOCKS.register("slab_sandstone_ebon_smooth", () -> new SlabBlock(Block.Properties.from(TerraBlockRegistry.SANDSTONE_EBON_SMOOTH.get())));
    ...
    public static final RegistryObject<Block> DUNGEON_BLUE_FLOOR_TILE = BLOCKS.register("dungeon_blue_floor_tile", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_FLOOR_SLAB = BLOCKS.register("dungeon_blue_floor_slab", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_BASE = BLOCKS.register("dungeon_blue_wall_base", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_TOP = BLOCKS.register("dungeon_blue_wall_top", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_MID = BLOCKS.register("dungeon_blue_wall_mid", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_WALL_BOT = BLOCKS.register("dungeon_blue_wall_bot", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_PILLAR = BLOCKS.register("dungeon_blue_pillar", () -> new RotatedPillarBlock(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_BRICK = BLOCKS.register("dungeon_blue_brick", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_BLUE_SLAB = BLOCKS.register("dungeon_blue_slab", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    ...
    public static final RegistryObject<Block> DUNGEON_GREEN_FLOOR_BRICK = BLOCKS.register("dungeon_green_floor_brick", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_FLOOR_TILE = BLOCKS.register("dungeon_green_floor_tile", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_FLOOR_SLAB = BLOCKS.register("dungeon_green_floor_slab", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_BASE = BLOCKS.register("dungeon_green_wall_base", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_TOP = BLOCKS.register("dungeon_green_wall_top", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_MID = BLOCKS.register("dungeon_green_wall_mid", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_WALL_BOT = BLOCKS.register("dungeon_green_wall_bot", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_PILLAR = BLOCKS.register("dungeon_green_pillar", () -> new RotatedPillarBlock(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_BRICK = BLOCKS.register("dungeon_green_brick", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_GREEN_SLAB = BLOCKS.register("dungeon_green_slab", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    ...
    public static final RegistryObject<Block> DUNGEON_RED_FLOOR_BRICK = BLOCKS.register("dungeon_red_floor_brick", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_FLOOR_TILE = BLOCKS.register("dungeon_red_floor_tile", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_FLOOR_SLAB = BLOCKS.register("dungeon_red_floor_slab", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_BASE = BLOCKS.register("dungeon_red_wall_base", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_TOP = BLOCKS.register("dungeon_red_wall_top", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_MID = BLOCKS.register("dungeon_red_wall_mid", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_WALL_BOT = BLOCKS.register("dungeon_red_wall_bot", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_PILLAR = BLOCKS.register("dungeon_red_pillar", () -> new RotatedPillarBlock(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_BRICK = BLOCKS.register("dungeon_red_brick", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> DUNGEON_RED_SLAB = BLOCKS.register("dungeon_red_slab", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(9.0F).harvestLevel(4).harvestTool(ToolType.PICKAXE)));
    ...
    //Structure Temple
    public static final RegistryObject<Block> TEMPLE_BRICK = BLOCKS.register("temple_brick", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(25.0F).harvestLevel(10).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> TEMPLE_BRICK_MOSSY = BLOCKS.register("temple_brick_mossy", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(25.0F).harvestLevel(10).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> TEMPLE_BRICK_CRACKED = BLOCKS.register("temple_brick_cracked", () -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(25.0F).harvestLevel(10).harvestTool(ToolType.PICKAXE)));
