...
public class TerraEffectRegistry
{
    ...
    public static final RegistryObject<Effect> INVINCIBILITY = EFFECTS.register("invincibility", () -> new TerraEffectInvincibility(EffectType.HARMFUL, 10859519).addAttributesModifier(Attributes.MOVEMENT_SPEED, "ae4302fc-42e8-4e9c-a081-1561cdf5de1c", -0.15F, AttributeModifier.Operation.MULTIPLY_TOTAL));
    ...
    public static final RegistryObject<Effect> POTION_SICKNESS = EFFECTS.register("potion_sickness", () -> new TerraEffectPotionSickness(EffectType.HARMFUL, 0));
