...
public final class TerraItemRegistry
{
    ...
    //Accessories
    public static final RegistryObject<Item> HORSESHOE_LUCKY = ITEMS.register("horseshoe_lucky", () -> new TerraItemLuckyHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_OBSIDIAN = ITEMS.register("horseshoe_obsidian", () -> new TerraItemObsidianHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> SKULL_OBSIDIAN = ITEMS.register("skull_obsidian", () -> new TerraItemObsidianSkull(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOTTLE_CLOUD = ITEMS.register("bottle_cloud", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOTTLE_BLIZZARD = ITEMS.register("bottle_blizzard", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOTTLE_SANDSTORM = ITEMS.register("bottle_sandstorm", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOTTLE_TSUNAMI = ITEMS.register("bottle_tsunami", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOTTLE_FART = ITEMS.register("bottle_fart", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_RED = ITEMS.register("balloon_red", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_CLOUD = ITEMS.register("balloon_cloud", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_BLIZZARD = ITEMS.register("balloon_blizzard", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_SANDSTORM = ITEMS.register("balloon_sandstorm", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_HONEY = ITEMS.register("balloon_honey", () -> new TerraItemHoneycomb(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_PUFFERFISH = ITEMS.register("balloon_pufferfish", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_SHARK = ITEMS.register("balloon_shark", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_FART = ITEMS.register("balloon_fart", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BALLOON_BUNDLE = ITEMS.register("balloon_bundle", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_BALLOON_CLOUD = ITEMS.register("horseshoe_balloon_cloud", () -> new TerraItemLuckyHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_BALLOON_BLIZZARD = ITEMS.register("horseshoe_balloon_blizzard", () -> new TerraItemLuckyHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_BALLOON_SANDSTORM = ITEMS.register("horseshoe_balloon_sandstorm", () -> new TerraItemLuckyHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_BALLOON_SHARK = ITEMS.register("horseshoe_balloon_shark", () -> new TerraItemLuckyHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_BALLOON_FART = ITEMS.register("horseshoe_balloon_fart", () -> new TerraItemLuckyHorseshoe(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HORSESHOE_BALLOON_HONEY = ITEMS.register("horseshoe_balloon_honey", () -> new TerraItemAmberHorseshoeBalloon(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> HONEYCOMB = ITEMS.register("honeycomb", () -> new TerraItemHoneycomb(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> NECKLACE_PANIC = ITEMS.register("necklace_panic", () -> new TerraItemPanicNecklace(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> NECKLACE_SWEETHEART = ITEMS.register("necklace_sweetheart", () -> new TerraItemSweetheartNecklace(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> NECKLACE_SHARKTOOTH = ITEMS.register("necklace_sharktooth", () -> new TerraItemSharktoothNecklace(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> NECKLACE_STINGER = ITEMS.register("necklace_stinger", () -> new TerraItemStingerNecklace(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> NECKLACE_CROSS = ITEMS.register("necklace_cross", () -> new TerraItemCrossNecklace(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> NECKLACE_STARVEIL = ITEMS.register("necklace_starveil", () -> new TerraItemStarveil(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> AGLET = ITEMS.register("aglet", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.05F));
    public static final RegistryObject<Item> ANKLET_OF_WIND = ITEMS.register("anklet_of_wind", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.10F));
    public static final RegistryObject<Item> LEG_FROG = ITEMS.register("leg_frog", () -> new TerraItemFrogLeg(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_AMPHIBIAN = ITEMS.register("boots_amphibian", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_DUNERIDER = ITEMS.register("boots_dunerider", () -> new TerraItemBootsDunerider(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_FAIRY = ITEMS.register("boots_fairy", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.20F));
    public static final RegistryObject<Item> BOOTS_FLOWER = ITEMS.register("boots_flower", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_FLURRY = ITEMS.register("boots_flurry", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.20F));
    public static final RegistryObject<Item> BOOTS_FROSTSPARK = ITEMS.register("boots_frostspark", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_HELLFIRE = ITEMS.register("boots_hellfire", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_HERMES = ITEMS.register("boots_hermes", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.20F));
    public static final RegistryObject<Item> BOOTS_ICE = ITEMS.register("boots_ice", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_LAVA = ITEMS.register("boots_lava", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_LIGHTNING = ITEMS.register("boots_lightning", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.30F));
    public static final RegistryObject<Item> BOOTS_OBSIDIAN = ITEMS.register("boots_obsidian", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_SAILFISH = ITEMS.register("boots_sailfish", () -> new TerraItemAccessorySpeed(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1), 0.20F));
    public static final RegistryObject<Item> BOOTS_SPECTRE = ITEMS.register("boots_spectre", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_TERRASPARK = ITEMS.register("boots_terraspark", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
    public static final RegistryObject<Item> BOOTS_WATER = ITEMS.register("boots_water", () -> new TerraItemAccessory(new Item.Properties().tab(TerraItemGroups.TERRA_TOOLS_TAB).stacksTo(1)));
