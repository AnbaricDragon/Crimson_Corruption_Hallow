...
//
//    public static final TagKey<Item> FROG_BREAKERS = ItemTags.create(Reference.path("frog_breakers"));
...
//    public static final TagKey<Item> WALL_CRAWLERS = ItemTags.create(Reference.path("wall_crawlers"));
