...
public class TerraTileEntityRegistry
{
    ...
    public static final RegistryObject<TileEntityType<TerraTileEntityHeartLantern>> LANTERN_HEART = TILE_ENTITIES.register("lantern_heart", () -> TileEntityType.Builder.create(TerraTileEntityHeartLantern::new, TerraBlockRegistry.TALL_LANTERN_HEART.get()).build(null));
}
