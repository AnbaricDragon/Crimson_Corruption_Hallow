...
public class BlizzardJumpPacket
{
    ...
    public BlizzardJumpPacket(int jumpModifier)
    {
        this.jumpModifier = jumpModifier;
    }

    public BlizzardJumpPacket(FriendlyByteBuf buffer)
    {
    ...
    public static BlizzardJumpPacket read(FriendlyByteBuf buf)
    {
        return new BlizzardJumpPacket(buf.readInt());
    }
