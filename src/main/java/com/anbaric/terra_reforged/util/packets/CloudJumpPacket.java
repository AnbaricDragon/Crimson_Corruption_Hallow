...
public class CloudJumpPacket
{
    ...
    public CloudJumpPacket(int jumpModifier)
    {
        this.jumpModifier = jumpModifier;
    }

    public CloudJumpPacket(FriendlyByteBuf buffer)
    {
    ...
    public static CloudJumpPacket read(FriendlyByteBuf buf)
    {
        return new CloudJumpPacket(buf.readInt());
    }
