...
public class FartJumpPacket
{
    ...
    public FartJumpPacket(int jumpModifier)
    {
        this.jumpModifier = jumpModifier;
    }

    public FartJumpPacket(FriendlyByteBuf buffer)
    {
    ...
    public static FartJumpPacket read(FriendlyByteBuf buf)
    {
        return new FartJumpPacket(buf.readInt());
    }
