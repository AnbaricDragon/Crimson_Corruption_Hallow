...
public class SandstormJumpPacket
{
    ...
    public SandstormJumpPacket(int jumpModifier)
    {
        this.jumpModifier = jumpModifier;
    }

    public SandstormJumpPacket(FriendlyByteBuf buffer)
    {
    ...
    public static SandstormJumpPacket read(FriendlyByteBuf buf)
    {
        return new SandstormJumpPacket(buf.readInt());
    }
