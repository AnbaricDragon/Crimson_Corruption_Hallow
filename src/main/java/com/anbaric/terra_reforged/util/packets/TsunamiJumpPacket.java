...
public class TsunamiJumpPacket
{
    ...
    public TsunamiJumpPacket(int jumpModifier)
    {
        this.jumpModifier = jumpModifier;
    }

    public TsunamiJumpPacket(FriendlyByteBuf buffer)
    {
    ...
    public static TsunamiJumpPacket read(FriendlyByteBuf buf)
    {
        return new TsunamiJumpPacket(buf.readInt());
    }
